...
const Navbar = () => {
  ...
  return (
    <nav
      className={`lg:backdrop-blur-lg dark:text-white text-black h-screen lg:w-screen lg:h-[10vh] flex justify-between fixed top-0 z-[1]`}
    >
      {isSmallScreen && (
      ...
      <div
        className={`flex flex-col justify-center lg:justify-end items-center transition-all ${
          ...
          isSmallScreen ? (navToggle ? "w-screen" : "w-[0px]") : "lg:w-screen"
        }`}
      >
        ...
        <div
          className={`${
            !isSmallScreen && "large-hoverMode"
          } contact h-[100px] w-[200px] lg:h-full flex items-center justify-center`}
          onClick={() => {
            stackDisplay("about");
